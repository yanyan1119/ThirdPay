...
#define AlixpayPaySuccess                     9000
#define AlixpaySuccessNotifycation            @"AlixpaySuccessNotifycation"

#define WechatpaySuccessNotifycation          @"WechatpaySuccessNotifycation"
